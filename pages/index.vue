    ...
    <div class="flex flex-col justify-center gap-y-5">
      ...
      <div class="flex justify-between">
        <div class="no-outline flex space-x-2 focus:outline-none bg-green-200 rounded-md py-2 px-5 font-bold text-slate-700">
          ...
          <svg v-if="isExecuting" width="44" height="44" viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg" stroke="#ffc626">
        ...
        <button
          v-else
          @click="handleExecute()"
          class="bg-yellow-400 rounded-full py-2 px-5 font-bold text-slate-700"
          :disabled="!runtimeCode || isExecuting">
          Execute
        </button>
      </div>
    </div>
